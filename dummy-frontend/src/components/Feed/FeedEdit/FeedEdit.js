...
class FeedEdit extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (this.props.selectedPost !== prevProps.selectedPost && this.props.selectedPost && this.props.selectedPost.imageUrl) {
      console.log(this.props)
      this.setState({
        ...this.state,
        imagePreview: `http://localhost:8080/images/${this.props.selectedPost.imageUrl}`
      })
    }
    if (
      this.props.editing &&
  ...
  acceptPostChangeHandler = () => {
    const post = {
      _id: this.props.selectedPost && this.props.selectedPost._id,
